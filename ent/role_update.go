...
func (ru *RoleUpdate) SetRoleID(s string) *RoleUpdate {
	ru.mutation.SetRoleID(s)
	return ru
}
...
// SetRoleID sets the "role_id" field.
func (ruo *RoleUpdateOne) SetRoleID(s string) *RoleUpdateOne {
	ruo.mutation.SetRoleID(s)
	return ruo
}
