...
func (rc *RoleCreate) check() error {
	...
	if v, ok := rc.mutation.RoleID(); ok {
		if err := role.RoleIDValidator(v); err != nil {
			return &ValidationError{Name: "role_id", err: fmt.Errorf(`ent: validator failed for field "Role.role_id": %w`, err)}
		}
	}
	if _, ok := rc.mutation.CreatedAt(); !ok {
...
// SetRoleID sets the "role_id" field.
func (u *RoleUpsert) SetRoleID(v string) *RoleUpsert {
	u.Set(role.FieldRoleID, v)
	return u
}

// UpdateRoleID sets the "role_id" field to the value that was provided on create.
func (u *RoleUpsert) UpdateRoleID() *RoleUpsert {
	u.SetExcluded(role.FieldRoleID)
	return u
}
...
// SetRoleID sets the "role_id" field.
func (u *RoleUpsertOne) SetRoleID(v string) *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.SetRoleID(v)
	})
}
...
// UpdateRoleID sets the "role_id" field to the value that was provided on create.
func (u *RoleUpsertOne) UpdateRoleID() *RoleUpsertOne {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateRoleID()
	})
}
...
// SetRoleID sets the "role_id" field.
func (u *RoleUpsertBulk) SetRoleID(v string) *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.SetRoleID(v)
	})
}
...
// UpdateRoleID sets the "role_id" field to the value that was provided on create.
func (u *RoleUpsertBulk) UpdateRoleID() *RoleUpsertBulk {
	return u.Update(func(s *RoleUpsert) {
		s.UpdateRoleID()
	})
}
